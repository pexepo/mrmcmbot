...
def add_media_submission(
    user_id: int, kind: str, media_type: str, file_id: str, caption: str | None = None
):
    ...
    cursor.execute(
        """
        INSERT INTO media_submissions (user_id, kind, media_type, file_id, caption)
        VALUES (?, ?, ?, ?, ?)
    """,
        (user_id, kind, media_type, file_id, caption),
    )
